...
import 'package:ward/utils/theme.dart';
import 'package:ward/view/pages/forget_password/forget_otp_screen.dart';
import 'package:ward/view/pages/register_screen/otp_screen.dart';
...
class PhoneForgetPassword extends StatefulWidget {
  const PhoneForgetPassword({Key? key}) : super(key: key);
                      ...
                      onPressed: () async {
                        if (_formKey.currentState!.validate()) print(phone);
                        {
                          ...
                          (users.allUsers.indexWhere((element) =>
                              ...
                              ? {
                                  users.snackBar(
                                      "Phone number is not found ", context)
                                }
                              : users.allUsers.forEach((element) {
                                  if (countryController.text + phone ==
                                      element.mobile) {
