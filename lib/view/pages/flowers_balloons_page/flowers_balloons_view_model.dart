...
class FlowerAndBalloonsPlacesViewModel extends ChangeNotifier {
  ...
  final FlowerBalloonsBannerRepository flowerBalloonsBannerRepository;

  FlowerAndBalloonsPlacesViewModel(this.flowersAndBalloonsPlacesRepository,
      this.flowerBalloonsBannerRepository);
  bool isLoading = true;
  ...
  Future<List<FlowersBalloonsBannerModel>>? banners;
  ...
  Future<void> getAllPlaces() async {
    ...
    places =
        flowersAndBalloonsPlacesRepository.getAllFlowersAndBalloonsPlaces();
  ...
  Future<void> getAllBanner() async {
    isLoading = true;
    banners = flowerBalloonsBannerRepository.getAllBanner();
    banners?.then((value) {
      isLoading = false;
      notifyListeners();
    });
