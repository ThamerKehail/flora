...
import '../../../widget/flowers_balloons_place_widget.dart';
import '../../../widget/home_widget/places_widget.dart';
import '../flowers_balloons_view_model.dart';

class SearchFlowersBalloonsPlaces extends SearchDelegate {
  @override
  ...
  Widget buildSuggestions(BuildContext context) {
    final allPlaces = context.watch<FlowerAndBalloonsPlacesViewModel>();

    List filterPlaces = allPlaces.resultPlaces!
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return query == ''
                    ? FlowersBalloonsWidget(placesModel: products[index])
                    : FlowersBalloonsWidget(placesModel: filterPlaces[index]);
              });
        });
  }
}
